...
namespace Adhesive {
    public class OneToManyBinding<TTargetMembers, TSourceMember> : MultiWayBinding {
        ...
        public OneToManyBinding(IEnumerable<Expression<Func<TTargetMembers>>> bindTargets, Expression<Func<TSourceMember>> bindSource, Func<object, TTargetMembers> valueConverter = null, bool applyLeft = false) {
